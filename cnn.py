...
# Filter类保存了卷积层的参数以及梯度，并且实现了用梯度下降算法来更新参数 ok?
class Filter(object):
    # width, height, depth -> Sequence OK ???
...
class ConvLayer(object):
    ...
    def update(self):
        ...
        for one_filter in self.filters:
            one_filter.update(self.learning_rate)

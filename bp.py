...
class ConstNode(object):
    def __init__(self, layer_index, node_index):
        ...
        self.layer_index = layer_index
        self.node_index = node_index
        # offset b has no upstream
        # self.upstream = []
        self.downstream = []
        self.output = 1
        # no need to give offset b delta
        # self.delta = 0
...
class Connection(object):
    def __init__(self, upstream_node: Node, downstream_node: Node):
        """
...
class Network(object):
    def __init__(self, layers: list):
        ...
        # from layer[0] to layer[layer_count-1-1] without output layer
        # as output layer input is from last hidden layer
    ...
    def predict(self, sample):
        ...
        # output of the output layer(layer[-1])
...
if __name__ == '__main__':
    ...
    network_example.dump()
    # print(network_example.layers[-1].nodes[-1])
